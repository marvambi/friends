...
export default function Profile() {
	...
	return (
		<GluestackUIProvider 
			...
			<SafeAreaView className={"flex items-center justify-center bg-yellow-100 h-full"}>
				<VStack
					space="md"
					justifyContent="center"
					alignItems="center" backgroundColor="gold" marginHorizontal={4} minWidth={"90%"} padding={2} borderRadius={20}>
					<Box minWidth="80%" justifyContent="center" alignItems="center" borderTopLeftRadius={20} borderTopRightRadius={20} marginRight={5} marginLeft={5}>
